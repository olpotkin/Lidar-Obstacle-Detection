...
struct Ray
{
  ...
  // resolution: the magnitude of the ray's step, used for ray casting,
  //             the smaller the more accurate but the more expensive.
    ...
    double                               sderr)
  {
        ...
        (castDistance<=maxDistance))
    {
      ...
      cloud->points.push_back(
        pcl::PointXYZ(castPosition.x + rx*sderr,
